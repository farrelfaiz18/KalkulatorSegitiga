...
public class LuasSegitigaSikuSiku extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luas_segitiga_siku_siku);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LuasSegitigaSikuSiku.this, Segitiga_Siku_Siku.class);
