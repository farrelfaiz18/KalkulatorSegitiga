...
public class KelilingSegitigaSembarang1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keliling_segitiga_sembarang1);
        ...
        buttonHitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sisi1Str.isEmpty() && sisi2Str.isEmpty() && sisi3Str.isEmpty()) {
                    Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi semua sisi!", Toast.LENGTH_LONG).show();
                } else if (sisi1Str.isEmpty()) {
                    if (sisi2Str.isEmpty() && sisi3Str.isEmpty()) {
                        Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi sisi 1, 2, dan 3", Toast.LENGTH_LONG).show();
                    } else if (sisi2Str.isEmpty()) {
                        Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi sisi 1 dan sisi 2", Toast.LENGTH_LONG).show();
                    } else if (sisi3Str.isEmpty()) {
                        Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi sisi 1 dan sisi 3", Toast.LENGTH_LONG).show();
                    }
                } else if (sisi2Str.isEmpty()) {
                    if (sisi3Str.isEmpty()) {
                        Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi sisi 2 dan 3", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi sisi 2", Toast.LENGTH_LONG).show();
                    }
                } else if (sisi3Str.isEmpty()) {
                    Toast.makeText(KelilingSegitigaSembarang1.this, "Harap isi sisi 3", Toast.LENGTH_LONG).show();
                } else {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(KelilingSegitigaSembarang1.this, Segitiga_Sembarang1.class);
