...
public class LuasSegitigaSamaKaki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luas_segitiga_sama_kaki);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LuasSegitigaSamaKaki.this, Segitiga_Sama_Kaki.class);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LuasSegitigaSamaKaki.this, KelilingSegitigaSamaKaki.class);
                startActivity(intent);
            }
        });
